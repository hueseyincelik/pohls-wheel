...
class GUI:
	def __init__(self):
		...
		dpg.create_context()
		dpg.create_viewport(title="Themenkreis 7 — Pohl's Wheel", width=1000, height=600, resizable=False)
		dpg.setup_dearpygui()
		...
		with dpg.window(tag='main_window'):
			...
			for item in ['connect_button', 'start_button', 'stop_button', 'save_button', 'serial_port_text', 'serial_port_input', 'file_name', 'file_name_input', 'exciter_frequency', 'exciter_frequency_input', 'exciter_frequency_mHz']:
	...
	def acquire(self):
		...
		while self.measure:
			try:
				...
				self.popup_message('Arduino Connection', 'Error: not enough values to unpack (expected 3)!\nTry restarting the Arduino!')
			else:
